...
alignment_years <- dnorm(2020:2220, 2037, 10)
...
ggplot(aes(y=value, fill=name, x=year)) +
  ...
  scale_fill_tableau() +
  labs(x="Year",y="Probability", fill="Forecast", subtitle="Forecast of AGI timeline vs. optimistic alignment solution forecast")
